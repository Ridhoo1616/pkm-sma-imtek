...
import { nomorWa, belumTerisi } from "@/lib/format";
              ...
              <div className="px-6 py-5">
                ...
                {wa ? (
                  <a
                    ...
                    className="mt-1 inline-block rounded-lg bg-green-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-green-700"
                  >
                    Chat WhatsApp
                  </a>
                ) : (
